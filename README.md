...
- [Tangram](https://github.com/broadinstitute/Tangram) was used to map the cells within each spot (https://github.com/broadinstitute/Tangram).  
    ...
    - IHC staining can be found on the figshare (DOI: [https://doi.org/10.6084/m9.figshare.20407344](https://doi.org/10.6084/m9.figshare.20407344.v1](https://doi.org/10.6084/m9.figshare.20407344](https://doi.org/10.6084/m9.figshare.20407344.v1]))  
<br>  
